...
//	ofDrawBitmapString(msg, 10, 20);
    ...
    ofSetColor(255);
    string msg = "Press s to save the image";
    ofDrawBitmapString(msg, 10, 20);
    ...
    ofDrawBitmapString(snapString, 700,250);
    
    
    ofSetHexColor(0xFFFFFF);
    if(snapCounter > 0) {
        img.draw(710,10,300,200);
        ofSetColor(255, 0, 0);
        ofDrawRectangle(700,0,500,220);
